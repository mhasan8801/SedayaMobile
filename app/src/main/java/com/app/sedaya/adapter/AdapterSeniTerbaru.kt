...
class AdapterSeniTerbaru (var activity: Activity, var data: ArrayList<Seni>) : RecyclerView.Adapter<AdapterSeniTerbaru.Holder>() {
    ...
    class Holder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val layout = view.findViewById<CardView>(R.id.layout_rekom_seni)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_rekom_seni, parent, false)
        return Holder(view)
    }
